...
- **我们**：双方当前心情、共同约定、心意券、待处理数量、未分享提醒，以及只对本人可见的“恋爱备忘录”。
...
API 必须携带 apiVersion: 2，旧版本请求返回 CLIENT_UPGRADE_REQUIRED。所有业务鉴权使用云函数取得的 OPENID，不接受客户端冒充作者或关系。“恋爱备忘录”保存在当前用户自己的 v2_users 文档中，只通过本人 profile.get / profile.memo.update 返回和修改，不会包含在 TA 的资料响应里。
